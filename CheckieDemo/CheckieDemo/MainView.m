...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.chkCircle.frame = CGRectMake(15, 50, self.chkCircle.frame.size.width, self.chkCircle.frame.size.height);
        ...
        self.chkImage.frame = CGRectMake(15, self.chkSquare.frame.origin.y + self.chkSquare.frame.size.height + 20, self.chkImage.frame.size.width, self.chkImage.frame.size.height);
        ...
        self.chkCircleLong.frame = CGRectMake(15, self.chkImage.frame.origin.y + self.chkImage.frame.size.height + 20, self.chkCircleLong.frame.size.width, self.chkCircleLong.frame.size.height);
